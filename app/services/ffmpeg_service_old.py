...
Using subprocess directly for better error handling and compatibility
"""
import subprocess
import json
import base64
...
class FFmpegService:
    ...
    def generate_thumbnail(
        ...
        """
        Generate thumbnail from video at specified timestamp using subprocess
        ...
        """
        try:
            # FFmpeg command to generate thumbnail as JPEG bytes
            cmd = [
                "ffmpeg",
                "-i", video_path,
                "-ss", str(timestamp),
            ...
            if result.returncode == 0:
                ...
                print(f"✓ Thumbnail generated: {len(thumbnail_base64)} chars, {len(result.stdout)} bytes")
